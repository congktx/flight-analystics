...
async def get_company_infos(ticker: Union[str | None] = None, exchange: Union[str | None] = None, limit: Union[int | None] = None, page: Union[int | None] = None):
    try:
        if limit == None:
            limit = 1000
        ...
        if page == None: 
            page = 1
        return mongodb.get_company_infos(ticker, exchange, limit, page)
