...
async def fetch_ohlc_for_tickers():
  ...
  async with aiohttp.ClientSession() as session:
    for ticker in companies["Cong"]:
            ...
            if ohlc and company_find and company_find.get('isQueryForOHLCByBTC2'):
            ...
            if company_find and company_find.get('next_url') and len(company_find['next_url'])>0:
